class ZCL_MATERIAL_TEST_PARAMETER definition
  public
  final
  create public .
...
public section.
  ...
  methods GET_MATERIAL_DATA
    importing
      ...
      !IM_MATATERIAL type ref to ZIF_MATERIAL
    exporting
...
CLASS ZCL_MATERIAL_TEST_PARAMETER IMPLEMENTATION.


  METHOD get_material_data.
    im_mataterial->get_material_data(
      EXPORTING
        im_matnr = im_matnr
        im_werks = im_werks
      IMPORTING
