...
public section.
  ...
  types:
     TS_AIR type SPFLI .
  types:
TT_AIR type standard table of TS_AIR .
  types:
  ...
  types:
     TS_AIR1 type ZSPFLI_V .
  types:
TT_AIR1 type standard table of TS_AIR1 .

  constants GC_AIR type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Air' ##NO_TEXT.
  constants GC_AIR1 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Air1' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZAIR_MPC==================CP' ##NO_TEXT.
...
CLASS ZCL_ZAIR_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZAIR_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Air' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'AirSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Air1' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Fltm' iv_abap_fieldname = 'FLTM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSPFLI_V'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Air1Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200921093353'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'Fltm'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Air1'.                            "#EC NOTEXT
