class ZCL_ZTEST_APC_DPC definition
  public
...
protected section.
  ...
  methods USERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZTEST_APC_MPC=>TS_USER
    raising
  ...
  methods USERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZTEST_APC_MPC=>TT_USER
...
CLASS ZCL_ZTEST_APC_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 08/27/2020 02:25:28 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZTEST_APC_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA userset_create_entity TYPE zcl_ztest_apc_mpc=>ts_user.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA userset_get_entity TYPE zcl_ztest_apc_mpc=>ts_user.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZTEST_APC_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA userset_get_entityset TYPE zcl_ztest_apc_mpc=>tt_user.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA userset_update_entity TYPE zcl_ztest_apc_mpc=>ts_user.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
