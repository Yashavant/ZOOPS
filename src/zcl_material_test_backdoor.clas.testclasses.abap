...
CLASS lcl_test DEFINITION DEFERRED.
  CLASS zcl_material_test_backdoor DEFINITION LOCAL FRIENDS lcl_test.
CLASS lcl_Test DEFINITION FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
  PRIVATE SECTION.
    DATA:
      f_Cut      TYPE REF TO zcl_material_test_backdoor,  "class under test
...
CLASS lcl_Test IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    f_Cut->gd_mataterial = f_material.
  ENDMETHOD.
