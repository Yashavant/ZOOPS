...
CLASS lcl_material_text_setter_test1 DEFINITION FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
  PRIVATE SECTION.
    DATA: f_doa TYPE REF TO zif_material_text1.
    DATA: f_cut TYPE REF TO zcl_material_text_setter_cut1." Code under test
    METHODS: setup.
...
CLASS lcl_material_text_setter_test1 IMPLEMENTATION.
...
* When
    CLEAR:act_Maktx.
    zcl_material_text_setter_cut1=>get_Material_Text(
      EXPORTING
        im_matnr = im_Matnr
        im_spras = im_Spras
     IMPORTING
