class ZCL_ZMM_PURCHASE_ORDER_DPC definition
  public
...
protected section.
  ...
  methods HEADERSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZMM_PURCHASE_ORDER_MPC=>TS_HEADER
    raising
  ...
  methods HEADERSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZMM_PURCHASE_ORDER_MPC=>TT_HEADER
  ...
  methods ITEMSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZMM_PURCHASE_ORDER_MPC=>TS_ITEM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ITEMSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZMM_PURCHASE_ORDER_MPC=>TT_ITEM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZMM_PURCHASE_ORDER_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 16.09.2020 05:25:02 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZMM_PURCHASE_ORDER_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA headerset_create_entity TYPE zcl_zmm_purchase_order_mpc=>ts_header.
 DATA itemset_create_entity TYPE zcl_zmm_purchase_order_mpc=>ts_item.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA headerset_get_entity TYPE zcl_zmm_purchase_order_mpc=>ts_header.
 DATA itemset_get_entity TYPE zcl_zmm_purchase_order_mpc=>ts_item.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZMM_PURCHASE_ORDER_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA headerset_get_entityset TYPE zcl_zmm_purchase_order_mpc=>tt_header.
 DATA itemset_get_entityset TYPE zcl_zmm_purchase_order_mpc=>tt_item.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA headerset_update_entity TYPE zcl_zmm_purchase_order_mpc=>ts_header.
 DATA itemset_update_entity TYPE zcl_zmm_purchase_order_mpc=>ts_item.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
