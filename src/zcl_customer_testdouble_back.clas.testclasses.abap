...
CLASS lcl_customer_test DEFINITION DEFERRED.
CLASS zcl_customer_testdouble_back DEFINITION LOCAL FRIENDS lcl_customer_test.
CLASS lcl_customer_test DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    DATA:
      f_cut  TYPE REF TO ZCL_CUSTOMER_TESTDOUBLE_BACK,  "class under test
