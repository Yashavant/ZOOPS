class ZCL_ZMM_PURCHASE_ORDER_MPC definition
  public
...
CLASS ZCL_ZMM_PURCHASE_ORDER_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZMM_PURCHASE_ORDER_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200916092500'.                  "#EC NOTEXT
