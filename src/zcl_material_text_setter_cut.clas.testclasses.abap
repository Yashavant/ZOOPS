...
CLASS lcl_material_text_setter_test DEFINITION FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
  PRIVATE SECTION.
    DATA:
      f_Cut TYPE REF TO zcl_Material_Text_setter_Cut,  "class under test
...
CLASS lcl_Material_Text_setter_Test IMPLEMENTATION.
