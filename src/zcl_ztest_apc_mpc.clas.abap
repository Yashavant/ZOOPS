class ZCL_ZTEST_APC_MPC definition
  public
...
CLASS ZCL_ZTEST_APC_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZTEST_APC_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZBC_USER'
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200827062526'.                  "#EC NOTEXT
